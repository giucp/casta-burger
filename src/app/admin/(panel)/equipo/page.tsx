...
export default async function EquipoPage() {
  ...
  return (
    <>
      ...
      <p className="mb-6 max-w-prose text-sm text-smoke">
        ...
        <br />
        <span className="text-smoke/80">
          Las contraseñas se ponen acá y se dicen de palabra. Si alguien la
          olvida, la otra persona se la cambia desde esta misma pantalla — no
          hace falta ningún correo.
        </span>
      </p>
